...
<td><b><%=resultSet.getString("sub6") %></b></td>
    ...
    String data= "select regdno,branch,semester,sub1,sub2,sub3,sub4,sub5,sub6 from  studentmark where internal=? and branch= ? and semester=? and regdno=?";
    ...
    preparedStatement.setString(4, regdno);
