...
<form name="student_entry" method="post" action="viewstudentprocess.jsp">
<table width="698" border="0" cellspacing="1" cellpadding="1"  bgcolor="#CCFFFF" align="center">
  <tr>
    <th height="33" colspan="2" align="center" bgcolor="#FFCC66" style="font-size:14px; font-family:Verdana, Arial, Helvetica, sans-serif; font-weight:bold" scope="col" >view student </th>
    </tr>
